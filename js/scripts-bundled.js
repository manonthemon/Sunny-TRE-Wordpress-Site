!(function (t) {
  ...
  (n.m = t),
    ...
    (n.p = "/wp-content/themes/fictional-university-theme/bundled-assets/"),
    n((n.s = 1));
})([
  function (t, e, n) {},
  function (t, e, n) {
    ...
    function y(t, e, n) {
      var i = {};
      for (var r in e)
        p(e[r]) ? (i[r] = e[r](t, i, n)) : o("Extension must be a function");
    ...
    function w(t, e) {
      ...
      return (
        e.hasOwnProperty("classes") &&
          ((n.classes = c({}, t.classes, e.classes)),
          e.classes.hasOwnProperty("direction") &&
            (n.classes.direction = c(
              {},
              t.classes.direction,
              e.classes.direction
            ))),
        e.hasOwnProperty("breakpoints") &&
          (n.breakpoints = c({}, t.breakpoints, e.breakpoints)),
        n
      );
    }
    var _ = (function () {
          ...
          a(t, [
            {
              key: "on",
              value: function (t, e) {
                if (g(t)) for (var n = 0; n < t.length; n++) this.on(t[n], e);
                ...
                case ">":
                  ">" === i
                    ...
                    ? (t.isType("slider") && !t.settings.rewind) ||
                      ((this._o = !0), (t.index = 0))
                    : s
                    ? (t.index += Math.min(n - t.index, -d(i)))
                    : t.index++;
                  break;
                case "<":
                  "<" === i
            ...
            c = {
              ...
              move: function (i) {
                ...
                if (!t.disabled) {
                  ...
                  this.enable(),
                    c > a && l < s.touchAngle
                      ? (s.perTouch && (f = Math.min(f, d(s.perTouch))),
                        e.Direction.is("rtl") && (f = -f),
                        e.Run.make(e.Direction.resolve("<" + f)))
                      : c < -a && l < s.touchAngle
                      ? (s.perTouch && (f = Math.max(f, -d(s.perTouch))),
                        e.Direction.is("rtl") && (f = -f),
                        e.Run.make(e.Direction.resolve(">" + f)))
                      : e.Move.make(),
